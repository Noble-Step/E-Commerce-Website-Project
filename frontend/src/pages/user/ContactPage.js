              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-black border rounded-lg px-4 py-3 focus:outline-none ${
                      errors.name
                        ? "border-red-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows="6"
                    className={`w-full bg-black border rounded-lg px-4 py-3 focus:outline-none resize-none ${
                      errors.message
                        ? "border-red-500"
                        : "border-gray-700 focus:border-yellow-400"
                    }`}
                ...
                <button
                  ...
                  className="w-full bg-yellow-400 text-black py-3 rounded-full font-semibold hover:bg-yellow-500 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900 rounded-2xl p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="w-12 h-12 bg-gray-800 hover:bg-yellow-400 hover:text-black rounded-full flex items-center justify-center transition"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl p-6 text-black">
              ...
              <button
                ...
                className="bg-black text-yellow-400 px-6 py-2 rounded-full font-semibold hover:bg-gray-900 transition text-sm"
              >
                Visit FAQ
              </button>
            </div>
